var slideTxt={
	thisBox:$('.Promotions .pbox'),//这里的样式名要与内容区保持一致
	btnLeft:$('.Promotions a.left'),
	btnRight:$('.Promotions a.right'),
	thisEle:$('.Promotions .pbox ul'),
	init:function(){
		slideTxt.thisBox.width(slideTxt.thisEle.length*238);//这个宽度等于内容区的宽度，是内容移出去的宽度
		slideTxt.slideAuto();
	...
	slideLeft:function(){
		...
		slideTxt.thisBox.css('marginLeft',-238);//这个宽度等于内容区的宽度，是内容移出去的宽度
